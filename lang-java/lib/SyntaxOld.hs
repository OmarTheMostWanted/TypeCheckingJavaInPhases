...
--   | VariableDeclarationStatement Type String Expression -- Variable declaration statement
--   | AssignmentStatement Expression Expression -- Assignment statement
--   | IncrementDecrementStatement Expression Bool -- Increment or decrement statement
--   | IfStatement Expression [Statement] [Statement] -- If-Else statement
--   | SwitchStatement Expression [(Expression, [Statement])] -- Switch statement
--   | ForLoopStatement Statement Expression Expression Expression [Statement] -- For loop statement
--   | EnhancedForLoopStatement Type String Expression [Statement] -- Enhanced for loop statement
--   | WhileLoopStatement Expression [Statement] -- While loop statement
--   | DoWhileLoopStatement Expression [Statement] -- Do-While loop statement
--   | BreakStatement -- Break statement
--   | ContinueStatement -- Continue statement
--   | ReturnStatement (Maybe Expression) -- Return statement
--   | ThrowStatement Expression -- Throw statement
--   | TryCatchStatement [Statement] [(Type, String, [Statement])] (Maybe [Statement]) -- Try-Catch statement
--   | SynchronizedStatement Expression [Statement] -- Synchronized statement
--   | MethodInvocationStatement Expression -- Method invocation used as a statement
--   deriving (Show)
